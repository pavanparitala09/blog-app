      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-10">
          <button
            ...
            className="p-2 -ml-2 hover:bg-slate-100 rounded-full transition-all text-slate-600"
          >
            <svg
              className="w-6 h-6"
              fill="none"
              ...
              {article.isArticleActive !== false ? (
                <>
                  <button
                    ...
                    className="px-4 py-1.5 border border-slate-200 rounded-full text-sm font-semibold hover:bg-slate-50 transition-colors"
                  >
                    Edit
                  </button>
                  <button
                ...
                <button
                  ...
                  className="px-6 py-1.5 bg-violet-600 text-white rounded-full text-sm font-bold shadow-md hover:bg-violet-700 transition-all"
                >
                  Restore Article
                </button>
              )}
          ...
          <>
            ...
            {isAuthor && article.isArticleActive === false && (
              <div className="mb-8 bg-red-50 border border-red-100 text-red-700 p-4 rounded-2xl text-center animate-pulse">
                ...
                <p className="text-[10px] mt-1">
                  Hidden from public view. Click 'Restore' to publish again.
                </p>
              </div>
            )}
            ...
            <article className="mb-12">
              <header className="mb-8">
                <span className="px-3 py-1 bg-violet-50 text-violet-600 text-[10px] font-bold uppercase tracking-widest rounded-md">
                  {article.category}
                </span>
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 pb-8">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs mt-1">
                      Author • {Math.ceil(article.content.length / 500)} min
                      read
                    </p>
                  </div>
                </div>
              ...
              <section className="text-slate-800 text-lg leading-relaxed whitespace-pre-wrap">
                {article.content}
              </section>

              {/* TIMESTAMPS */}
              <div className="mt-12 pt-6 border-t border-slate-50 flex flex-col sm:flex-row sm:justify-between gap-4">
              ...
              <div className="fixed bottom-0 left-0 w-full bg-white/80 backdrop-blur-md border-t p-4 z-50">
                <div className="max-w-2xl mx-auto">
                  <form
                    ...
                    className="flex items-center border bg-slate-50 rounded-2xl px-4 py-2.5"
                  >
                    <input
                      type="text"
                    ...
                    <button
                      ...
                      className="text-violet-600 font-bold text-sm ml-2 disabled:text-slate-300"
                    >
                      Post
                    </button>
                  </form>
            ...
            {/* AUTHOR MODE BANNER */}
            {isAuthor && (
              <div className="mt-10 bg-violet-50/50 rounded-2xl p-6 text-center border border-violet-100">
                <p className="text-xs font-bold text-violet-900 uppercase tracking-widest">
                  Author Mode
                </p>
                <p className="text-violet-600/70 text-[10px] mt-1 italic">
